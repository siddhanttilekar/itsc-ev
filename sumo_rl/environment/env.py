...
class SumoEnvironment(gym.Env):
    ...
    def reset(self, seed: Optional[int] = None, **kwargs):
        ...
        if self.single_agent:
            return self._compute_observations()[self.ts_ids[0]], self._compute_info()  # Return observation and info
        else:
            return self._compute_observations(), self._compute_info()  # Return observation and info for multi-agent setup
